...
`.poster-art,.poster-art>img,.poster-art>.trailer-poster-frame,.poster-fallback{position:absolute;inset:0;width:100%;height:100%}.poster-art>img,.poster-art>.trailer-poster-frame{object-fit:cover;transition:transform .35s}.poster-art>.trailer-poster-frame{border:0;pointer-events:none;background:#141c28;opacity:0}.poster-art>.trailer-poster-frame.ready{opacity:1}`,
'catalog poster css');
css=replaceOnce(css,
...
`.detail-poster img{object-fit:cover}.detail-poster-video{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;border:0;pointer-events:none;background:#111822;opacity:0}.detail-poster-video.ready{opacity:1}`,
'detail poster css');
css=replaceOnce(css,
